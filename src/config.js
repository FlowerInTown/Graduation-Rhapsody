...
export const HE3_HARVEST_DURATION = 5;       // 采集氦三读条时长(秒)
...
export const HARVEST_BTN_TOOLTIP = '采集飞船能量'; // 采集按钮悬浮提示
...
export const DETECTOR_BTN_TOOLTIP = '周围出现旅行者，会自动发出警告'; // 检测装置悬浮提示
...
export const FIND_FRIEND_BTN_TOOLTIP = '尝试寻找这里的旅行者，最好等检测到再使用'; // 召唤朋友按钮悬浮提示
...
// ----- 新手引导 -----
export const TUTORIAL_SKIP = true;          // 开启后跳过新手引导

// ----- 调试 -----
export const DEBUG_START_NEAR_HOME = false;  // 开启后出生点直接放在故乡行星附近的星系（方便测试结局流程）

// ----- 序章 -----
export const PROLOGUE_SKIP = false;          // 开启后跳过序章
...
export const BAD_NPC_SPAWN_CHANCE = 0.01;
...
export const INTRA_SYSTEM_FLIGHT_DIST = 30; // 星系内飞行的虚拟距离(影响飞行时长)

// ----- 飞行画面 -----
export const FLIGHT_DURATION_MULT = 0.5;    // 飞行时长系数 (时长 = 距离 × 系数 秒)
...
export const FLIGHT_SKIP_INITIAL = 3;        // 跳跃道具初始次数
